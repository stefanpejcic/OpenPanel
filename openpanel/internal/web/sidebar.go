...
func BuildSidebarNav(allowed map[string]bool, path string) []NavGroup {
	...
	if has("wordpress", "drupal", "joomla", "opencart", "nextcloud", "prestashop", "website_builder", "nodejs", "python") {
		var links []NavLink
		...
		open := hasAnyPrefix(path, "/auto-installer", "/sites", "/website", "/wordpress", "/drupal", "/joomla", "/opencart", "/nextcloud", "/prestashop", "/pm2", "/nodejs", "/python")
