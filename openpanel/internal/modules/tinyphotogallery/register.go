...
func Register(mux *http.ServeMux, a *appctx.App) {
	...
	mux.Handle("POST /tinyphotogallery/backup/restore/{selected_domain...}", requireLogin(func(w http.ResponseWriter, r *http.Request) { handleTinyPhotoGalleryRestoreBackup(a, w, r) }))
	mux.Handle("POST /tinyphotogallery/backup/run/{selected_domain...}", requireLogin(func(w http.ResponseWriter, r *http.Request) { handleTinyPhotoGalleryRunBackup(a, w, r) }))
}
