...
// mirrors drupal/backups.go and flarum/backups.go's layout and naming, minus everything database-related since TinyPhotoGallery has no database
...
// handleTinyPhotoGalleryGetBackupDates mirrors drupal/backups.go's handleDrupalGetBackupDates, minus the database-backup flag
...
// handleTinyPhotoGalleryRestoreBackup mirrors drupal/backups.go's handleDrupalRestoreBackup, files-only
...
// handleTinyPhotoGalleryRunBackup mirrors drupal/backups.go's handleDrupalRunBackup, files-only
