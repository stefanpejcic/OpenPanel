...
// RegisterAPI wires POST /api/python/install onto mux, gated behind the "python" feature flag - see nodejs.RegisterAPI's comment, same shared appinstall.HandleInstall, no API-specific variant needed
