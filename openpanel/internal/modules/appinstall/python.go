...
// Python-specific install/run tokens and template-display config, kept apart from nodejs.go/ruby.go so each type is easy to find and change independently
