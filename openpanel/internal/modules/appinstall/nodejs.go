...
// NodeJS-specific install/run tokens and template-display config, kept apart from python.go/ruby.go so each type is easy to find and change independently
