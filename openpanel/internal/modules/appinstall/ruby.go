...
// Ruby-specific install/run tokens and template-display config, kept apart from nodejs.go/python.go so each type is easy to find and change independently
