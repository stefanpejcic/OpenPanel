...
// Register wires the dynamic DNS routes onto mux - the webcall update endpoint is deliberately NOT behind auth.RequireLogin, it's a public token-authenticated URL a router/IoT device calls
