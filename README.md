...
| AlmaLinux | 10 | 2026-06-27 14:30 UTC | ❌ Fail |  |
| RockyLinux | 9.6 | | | |
| RockyLinux | 10 | 2026-06-26 18:30 UTC | ❌ Fail | *Must manually switch from `nftables` to `iptables` first ([#1472](https://github.com/docker/for-linux/issues/1472))* |
| CentOS | 9.5 | | | |
