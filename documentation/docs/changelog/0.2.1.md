...
### 💅 Polish
- [Faster account creation](#user-add-speed)
...
With microoptimizations fo the `opencli user-add` script, we managed to decrease user creation speed from an average of 25 seconds to 3 seconds!
