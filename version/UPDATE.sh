...
# Make backup first
cp "$config_file" "$backup_file" && echo "Backup created at $backup_file"


# Insert activity_lines_retention=1500 after activity_items_per_page (only if not already present)
