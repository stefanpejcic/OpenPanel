...
docker_compose_up(){
    ...
    # Ensure consistent handling of aarch64 architecture
    if [ "$architecture" == "aarch64" ]; then
        echo "Detected ARM (AArch64) architecture. Applying specific Docker configurations."
        ...
        # Add ARM-specific Docker image replacements if needed
        # TODO: Test and validate all ARM-specific Docker configurations thoroughly.
        branch="armcpu"
    else
        branch="110"
    fi

    # Add a note for future maintainers
    # TODO: Test and validate all ARM-specific configurations thoroughly.
