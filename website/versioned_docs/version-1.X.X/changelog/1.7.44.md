...
- [WP Vulnerabilities in Site Manager](/img/docs-content/QXnfmvV6-2026-02-19-15-28.png).
- [Last login log is now visible on *OpenAdmin > Users > single user* page](/img/docs-content/k78mv7Tq-admin-login-log.png).
...
- [Option to view SSL-related logs for domain from *OpenAdmin > Domains* page](/img/docs-content/Z4rtMp9V-2026-02-20-14-41.png).
