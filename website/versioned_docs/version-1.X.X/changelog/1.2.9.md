...
- fixed css bug with server hostname display in OpenAdmin sidebar.
...
- fixed bug with [multiple swap notifications due to swap number in title of notification](/img/docs-content/xTQVrbgp-2025-05-14-11-30.png)
...
- [Hosting package UI limit inconsistency #487](https://github.com/stefanpejcic/OpenPanel/issues/487)
