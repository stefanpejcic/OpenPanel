...
- [Improvements to *OpenPanel > Dashboard > Usage* widget](/img/docs-content/PhmYgBBf-2025-08-08-12-23.png).
- [Improvements to *OpenPanel > PM2 > Install* page](/img/docs-content/44WNtCkb-2025-08-07-15-47.png).
...
- [Added options to reinstall all plugins and check plugins checksum on WP Manager](/img/docs-content/mrq5V6Km-2025-08-07-19-16.png).
...
- Removed timeout limit for `backup` command executed via *OpenPanel > Docker > Terminal* for `backup` service.
...
- [fixed bug with `MemPerc` returning incorrect values on  *OpenPanel > Dashboard > Usage* widget](/img/docs-content/TwsjyyFH-2025-08-08-12-46.png).
