...
- [added type and websites count columns to Domains](/img/docs-content/kCj8Fcsz-2025-07-31-17-54.png).
- [Improvements to Database Wizard interface and validations](/img/docs-content/rVBfJ0tY-2025-07-31-19-08.png).
...
- fixed bug on *OpenAdmin > License* displaying 'No License Key' in the field when no key is added.
