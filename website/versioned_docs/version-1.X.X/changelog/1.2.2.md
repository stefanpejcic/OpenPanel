...
- fixed permissions issue for php containers.
...
- fixed bug detecting user's ip address from ip.json file.
...
- fixed error *Failed to set ownership for the..* in FileManager for: create folder, create file, download with wget, upload files.
