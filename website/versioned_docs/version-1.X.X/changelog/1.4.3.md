...
- [tooltips on *OpenAdmin > Settings > OpenPanel* page](/img/docs-content/zX0pQnFK-2025-06-17-12-33.png).
- [better formating of the 'CPU Usage' admin notification](/img/docs-content/T257Nkkb-2025-06-17-13-14.png).
...
- [WP Manager now has options to Shuffle Salts, Verify WP core checksum and reinstall WP core files](/img/docs-content/1svHsNY4-2025-06-20-14-27.png).
