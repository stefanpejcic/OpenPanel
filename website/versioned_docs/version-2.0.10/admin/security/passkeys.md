...
Passkeys let you sign in to your own OpenAdmin account using your device's built-in authentication (fingerprint, face recognition, security key, or PIN) instead of, or in addition to, a password.

Use **OpenAdmin > Security > Passkeys** to manage them.

## Register a Passkey

1. Open the **Passkeys** page.
2. Click to register a new passkey and follow your browser/OS prompt (Windows Hello, Touch ID, a hardware security key, etc.).
3. Optionally rename the passkey to something recognizable (e.g. "Work laptop").
