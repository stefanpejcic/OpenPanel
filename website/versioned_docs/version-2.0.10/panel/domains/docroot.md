...
![Change docroot form with the document root folder field](/img/openpanel-screenshots/domains/docroot-form.png#gh-light-mode-only)
![Change docroot form with the document root folder field](/img/openpanel-screenshots/domains/docroot-form_dark.png#gh-dark-mode-only)
