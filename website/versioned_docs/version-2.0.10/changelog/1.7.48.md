...
### 💅 Polish
- [OpenAdmin now supports importing account from CyberPanel backup](/img/docs-content/R9kKvzHM-2026-03-12-21-08.png)
...
- [Interactive terminal on *OpenAdmin > Web Terminal*](/img/docs-content/NgB4dbms-Snimak-ekrana-napravlen-dana-2026-03-20-12-21-13.png).
...
- Added validation of DNS zone file and Caddyfile before reloading the service, when saving file for domain from *OpenAdmin > Domains* page, along with [temporary files that can be restored if validation fails](/img/docs-content/QhWrpgQG-Snimak-ekrana-napravlen-dana-2026-03-20-13-56-41.png).
