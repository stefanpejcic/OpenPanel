...
- *OpenAdmin > Dashboard > System Information* widget links processes to [Process Manager](/docs/admin/advanced/processes/)
...
- certbot is removed from all OpenAdmin routes: logs, resources, app.py..
