...
- [added indicator in top-right corner on OpenAdmin when service restart is needed after configuration changes](/img/docs-content/ncsSLZw1-2025-06-27-21-01.png).
- [services on *OpenAdmin > Services > Status* now display if service restart is needed](/img/docs-content/9Fv8RS6H-2025-06-27-21-01-1.png).
* **New Settings for Administrators in OpenAdmin → OpenPanel Settings:**
  ...
  * 
    [View screenshot →](/img/docs-content/51x3ykqB-2025-06-27-18-43.png)
