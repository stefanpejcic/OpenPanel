...
- [MySQL Processes don't see Mariadb Processes #398](https://github.com/stefanpejcic/OpenPanel/issues/398)
- [MySQL Configuration do not sync. #401](https://github.com/stefanpejcic/OpenPanel/issues/401)
- [Switch from mariadb to mysql don't work #400](https://github.com/stefanpejcic/OpenPanel/issues/400)
...
[![varnish.png](/img/docs-content/8z975g8v-varnish.png)](/img/docs-content/8z975g8v-varnish.png)
