...
### 💅 Polish
- Added ['services' module](/img/docs-content/08pmwZFG-slika.png), enabling users to view system service statuses, start or stop services, and monitor current resource usage.
...
- [Redis, Memcached, Elasticsearch, Opensearch and Varnish pages will now display real-time resurce usage if service is active and 'docker' feature enabled for user](/img/docs-content/MxCWSDrj-2025-10-22-17-22.png).
...
- [fixed css bug on *Firewall* widget on Site Manager](/img/docs-content/qqGKZ1Cm-2025-10-20-14-11.png).
