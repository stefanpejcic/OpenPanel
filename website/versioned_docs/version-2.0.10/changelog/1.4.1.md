...
### 💡 New
- [PHP Options and PHP.INI files can now be edited via *OpenAdmin > Settings > PHP* page](/img/docs-content/cWVpLSHm-ini.png).

### 💅 Polish
- better formating on *OpenPanel > CronJobs* table.
- [notification settings are separated to *OpenAdmin > Settings > Notifications* page](/img/docs-content/KZ47HfKY-2025-06-13-20-43.png).
