...
- [MySQL connection details are now displayed in both *Databases* and *Remote MySQL* pages](/img/docs-content/S4ZCzNkk-2025-08-25-16-20.png).
...
- Percona MySQL server is tested as drop-in replacement, and documented: [How to set MySQL, MariaDB, or Percona per user](https://openpanel.com/docs/articles/containers/how-to-set-mysql-mariadb-per-user-in-openpanel/)
