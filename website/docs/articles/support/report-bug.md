...
Please **only open a ticket for sales, or marketing-related** matters.
...
If you’ve found a bug, you can report it in one of the following ways:

* Use the **“Found a bug? Let us know”** link at the bottom of the page
* Open an issue directly on GitHub:
  [https://github.com/stefanpejcic/OpenPanel/issues/new/choose](https://github.com/stefanpejcic/OpenPanel/issues/new/choose)

Once submitted, our team is immediately notified. The appropriate team member will investigate, reproduce the issue, and work on a fix as soon as possible.
