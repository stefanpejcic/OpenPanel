...
- `/etc/openpanel/docker/compose/nodejs.yml`       - Used for new docker services via 'OpenPanel > Websites > Install App > NodeJS' page.
- `/etc/openpanel/docker/compose/python.yml`       - Used for new docker services via 'OpenPanel > Websites > Install App > Python' page.
- `/etc/openpanel/docker/compose/ruby.yml`       - Used for new docker services via 'OpenPanel > Websites > Install App > Ruby' page.
- `/etc/openpanel/docker/compose/java.yml`       - Used for new docker services via 'OpenPanel > Websites > Install App > Java' page.
