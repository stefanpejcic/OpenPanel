...
Deliberately simpler than the WordPress API below: install, list, and uninstall only — no cloning, no filesystem scan, no hardening rules, no drush passthrough. MySQL/MariaDB only.

### List all Drupal installations
