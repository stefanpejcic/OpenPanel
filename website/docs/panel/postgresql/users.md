...
![PostgreSQL Users page listing database users with Change Password and Delete buttons](/img/openpanel-screenshots/postgresql/users-list.png)
...
![Change User Password form with the username prefilled and a new password field](/img/openpanel-screenshots/postgresql/password-form.png)
...
![Delete button turned into a Confirm button with a countdown after the first click](/img/openpanel-screenshots/postgresql/users-delete.png)
