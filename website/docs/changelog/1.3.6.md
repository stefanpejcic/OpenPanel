...
- [Drag&Drop Site Builder with TailwindCSS blocks](/img/docs-content/3rwh6Kp8-2025-06-02-14-54.png)
- [Drag&Drop file upload in *OpenPanel > FileManager*](/img/docs-content/RSDpS9yV-2025-06-02-14-49.png) and *OpenPanel > Upload Files*.
- [Live html preview on *OpenAdmin > Domains > Edit Domain Templates* page](/img/docs-content/0j7nCVmX-25c1a2d63b4132.gif)
...
- [added table with docker stats history in *OpenAdmin > Users > single user*](/img/docs-content/vb27SffN-2025-06-03-14-30.png)
- email notifications feature is now disabled by default.
- default php version setting is removed from *OpenAdmin > Settings > OpenPanel* page.
- username is no longer random generated on *OpenAdmin > Users >  Add* form.
- [Varnish cache is now indicated on the Webserver field in *OpenAdmin > Users > Add* form](/img/docs-content/G2vq1GgH-2025-06-04-12-03.png).
- [*OpenAdmin > Settings > Edit Defaults* page is added for Administrators to configure defaults for new user accounts](/img/docs-content/qqbnf7rN-2025-06-04-12-04.png).
...
### 🐛 Bug Fixes
- [fixed bug with vercel blocking ip address checks on OpenAdmin login page](/img/docs-content/hGLQtNLG-2025-06-02-17-29.png).
...
- [fixed error `{"error":"CSRF error","message":"The CSRF token is missing."}` on auto-login to OpenAdmin from WHMCS](/img/docs-content/q7xgTyrh-2025-06-02-17-31.png).
- [fixed css issue when using ctrl key on Windows for selecting files in *OpenPanel > FileManager* table](/img/docs-content/QN7746YS-2025-06-02-18-18.png).
