...
- added option to restore default extensions in [*OpenAdmin > Settings > OpenPanel > File Manager*](/img/docs-content/rydPd9z4-2025-07-03-16-38.png).
- added logo preview on [*OpenAdmin > Settings > OpenPanel > Logo*](/img/docs-content/5xhYd4LM-2025-07-03-16-42.png).
