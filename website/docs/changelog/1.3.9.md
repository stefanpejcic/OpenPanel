...
### 💡 New
- [*OpenPanel > PostgreSQL* BETA](/img/docs-content/4y3n59k3-2025-06-09-16-13.png).
...
- [added an option to flush WP Cache from WP Manager](/img/docs-content/rw230vvh-2025-06-10-17-45.png).
- [added an option to enable/disable Maintenance Mode from WP Manager](/img/docs-content/W1cdtwTG-2025-06-10-18-54.png).

### 💅 Polish
- sidebar state in OpenPanel and OpenAdmin UI is now stored in browser storage.
- [better formatting on *OpenAdmin > Users > single user > Activity* table](/img/docs-content/B6gWG2Jc-2025-06-09-07-37.png).
...
- [fixed css bug on OpenAdmin sidebar causing DNS Zone Editor to be active on DNS Cluster page](/img/docs-content/G2VbfkK7-2025-06-09-07-48.png).
