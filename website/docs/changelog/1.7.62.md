...
### 🐛 Bug Fixes
- [OpenAdmin 500 error on new install of 1.7.62: (sqlite3.OperationalError) no such column: user.totp_secre  #993](https://github.com/stefanpejcic/OpenPanel/issues/993)
