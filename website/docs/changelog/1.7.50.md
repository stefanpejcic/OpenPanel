...
- [Set a separate domain for OpenPanel UI](/docs/articles/dev-experience/separate-domain-for-openpanel-access).
- [Removing the Port for OpenAdmin](/docs/articles/dev-experience/remove-custom-port-for-openadmin)
- [Removing the Port for OpenPanel](/docs/articles/dev-experience/remove-custom-port-for-openpanel)
...
- [`--over-quota` flag removed from `opencli user-list` command](https://github.com/stefanpejcic/opencli/commit/588d833329ef16e7fd018d740523ddd3849a6a6b).
...
### 🐛 Bug Fixes
- [postgresql db creation fails #908](https://github.com/stefanpejcic/OpenPanel/issues/908)
- [404 on /postgresql/pgadmin #903](https://github.com/stefanpejcic/OpenPanel/issues/903)
...
- [/wordpress/secure not working for a subfolder installations #907](https://github.com/stefanpejcic/OpenPanel/issues/907)
