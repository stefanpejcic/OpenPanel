...
- fixed 500 error in *OpenPanel > FileManager* when downloading archive with wget.
...
- fixed bug with the install script on contabo causing ipv6 to be used for downloading from github.
