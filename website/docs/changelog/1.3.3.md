...
### 💅 Polish
- [*copy* and *move* drawers on *OpenPanel > FileManager* now allow user to select a folder using the tree view.](/img/docs-content/vZB8SJ85-2025-05-27-17-05.png)
...
- [Google PageSpeed API errors are now displayed on WP Manager](/img/docs-content/1sjJJLmH-2025-05-27-19-26.png)
