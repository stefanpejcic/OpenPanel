...
- Administrators can now edit services from *OpenAdmin > Services > Edit* page.
...
- [crashlogs are now accessible trough notifications or *View Logs* page in OpenAdmin](https://i.postimg.cc/M6PLKzsT/2025-05-01-08-30.png).
...
- fixed error starting docker after reboot on Alma 9.5: `error creating default "bridge" network: cannot create network`
