...
### 💅 Polish
- BETA support for OpenLitespeed
...
- [password reset functionality is restored](https://openpanel.com/docs/panel/intro/#password-reset).
- *restart needed* button on OpenAdmin > Dashboard is now visible to Reseller users as well.
- [Added resource usage widget on top-right of OpenAdmin](/docs/admin/dashboard/#sse-usage).
...
- [On Export DNS Zone option, error is logged #655](https://github.com/stefanpejcic/OpenPanel/issues/655)
