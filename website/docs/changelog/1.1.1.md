...
![phpmyadmin](/img/docs-content/8TqVvXrJ-2025-03-05-17-19.png)

#### DB Size Unit

Users now have the option to select the unit of measurement for displaying database size.

![db size units](/img/docs-content/rpjgMGZk-2025-03-05-19-47.png)
...
![edit php limits](/img/docs-content/qvwpnR1G-2025-03-05-21-11.png)
