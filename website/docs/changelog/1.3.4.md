...
- [*OpenAdmin > Users* and *OpenAdmin > Users > single user* pages now display time when user was suspended](/img/docs-content/zBmj3QvP-2025-05-30-13-44.png).
- [*OpenAdmin > Users* now has additional columns: Email, Domains, 2FA, Containers, NetIO, PIDs](/img/docs-content/7HhCGmSm-2025-05-29-19-06.png).
...
- [CPU and RAM usage are now rounded to two decimal places on *OpenAdmin > Users > Single User*](/img/docs-content/Hsynwt74-2025-05-28-13-06.png).
- [Users in Enterprise Edition can now be created on remote servers from *OpenAdmin > Users > Add New* page](/img/docs-content/Dwp6Zy6m-2025-05-28-17-19.png).
- added flash error messages in DNS Zone Editor when zone file for domain is missing.
- [OpenAdmin > Domains > DNS Zone Editor](/img/docs-content/CwNWBppg-2025-05-29-14-02.png).
