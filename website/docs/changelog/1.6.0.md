...
- [Added descriptive error messages to OpenAdmin](/img/docs-content/BbVs5HdR-2025-09-05-19-31.png).
- [added status flag for `opencli user/varnish` command](https://dev.openpanel.com/cli/users.html#Varnish).
- added 'New Service' button in *OpenPanel > Containers* page allowing users to add new docker services.
...
- fixed 500 error on OpenPanel UI autologin from OpenAdmin
...
- [Bug in OpenAdmin UI: saving email client results in 404 #678](https://github.com/stefanpejcic/OpenPanel/issues/678)
