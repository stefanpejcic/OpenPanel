...
- [Improvements to *OpenAdmin > Settings > User Defaults* page](/img/docs-content/LHnv8McC-2025-08-20-16-08.png).
...
- 'Import Database' page now displays mysql_type: MariaDB or MySQL.
...
- fixed caching issue on `/temporary-link` from WP Manager causing same link to be displayed for all websites for 15min.
...
- fixed 404 error on `/cache/varnish` page.
