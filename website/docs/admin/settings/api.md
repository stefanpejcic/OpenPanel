...
2. **Browse the API reference**
   ...
   ![API Access page with API access enabled, the Download spec and Disable API access buttons, and the interactive OpenAdmin API reference](/img/openadmin-screenshots/settings/api_server-enabled.png)
...
5. **View the response and curl command**
   ...
   ![An API endpoint expanded in the API reference after Try it out and Execute, with the curl command, request URL and server response](/img/openadmin-screenshots/settings/api_server-try.png)
