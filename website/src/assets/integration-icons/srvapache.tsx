...
const SvgSrvapache = (props: SVGProps<SVGSVGElement>) => (
  ...
  <svg
    ...
    />
    <path fill="#BD202E" d="M74.234 58.596c-.467.081-.94.17-1.437.252 0 0-.007 0-.007.007l.74-.111c.23-.052.467-.096.704-.148Z" />
    <path fill="#BD202E" d="M74.234 58.596c-.467.081-.94.17-1.437.252 0 0-.007 0-.007.007l.74-.111c.23-.052.467-.096.704-.148Z" opacity=".35" />
    <path fill="#BD202E" d="M75.456 52.559s0 .007 0 0c-.007 0-.007 0-.007.007.074-.007.155-.022.23-.037.31-.044.614-.096.91-.17-.37.067-.74.133-1.133.2Z" />
    <path fill="#BD202E" d="M75.456 52.559s0 .007 0 0c-.007 0-.007 0-.007.007.074-.007.155-.022.23-.037.31-.044.614-.096.91-.17-.37.067-.74.133-1.133.2Z" opacity=".35" />
    <path
        fill="url(#b)"
        d="M70.071 34.76a219.903 219.903 0 0 1 3.37-6.081 171.901 171.901 0 0 1 3.585-5.97c.067-.112.148-.23.215-.341a144.48 144.48 0 0 1 3.607-5.444l-3.651-6.904a71.1 71.1 0 0 0-.83 1.03 156.993 156.993 0 0 0-3.274 4.23 201.146 201.146 0 0 0-3.889 5.392 233.315 233.315 0 0 0-3.703 5.48 214.99 214.99 0 0 0-3.163 4.978c-.037.06-.074.126-.11.193l4.762 9.407a213.91 213.91 0 0 1 3.081-5.97Z"
    />
    <path
        fill="url(#c)"
        d="M48.383 87.735a421.232 421.232 0 0 0-1.896 5.296c-.008.022-.015.052-.03.074-.089.252-.185.511-.266.763-.43 1.215-.8 2.311-1.652 4.793 1.4.637 2.526 2.325 3.592 4.236a7.624 7.624 0 0 0-2.489-5.273c6.911.31 12.867-1.437 15.948-6.489.274-.452.526-.919.755-1.43-1.4 1.778-3.14 2.526-6.407 2.348-.007 0-.014.008-.022.008.008 0 .015-.008.022-.008 4.815-2.155 7.222-4.222 9.363-7.644.504-.814 1-1.696 1.504-2.681-4.208 4.318-9.074 5.548-14.207 4.615l-3.852.422c-.126.326-.237.644-.363.97Z"
    />
    <path
        fill="url(#d)"
    ...
    />
    <path fill="#BD202E" d="M73.516 58.729c-.245.044-.49.081-.741.111.252-.022.503-.067.74-.111Z" />
    <path fill="#BD202E" d="M73.516 58.729c-.245.044-.49.081-.741.111.252-.022.503-.067.74-.111Z" opacity=".35" />
    <path fill="url(#h)" d="M73.516 58.729c-.245.044-.49.081-.741.111.252-.022.503-.067.74-.111Z" />
    <path fill="#BD202E" d="M75.449 52.566c.074-.007.155-.022.23-.037-.075.008-.149.03-.23.037Z" />
    <path fill="#BD202E" d="M75.449 52.566c.074-.007.155-.022.23-.037-.075.008-.149.03-.23.037Z" opacity=".35" />
    <path fill="url(#i)" d="M75.449 52.566c.074-.007.155-.022.23-.037-.075.008-.149.03-.23.037Z" />
    <path fill="#BD202E" d="M75.449 52.566c.007 0 .007-.007 0 0 .007-.007.007 0 0 0Z" />
    <path fill="#BD202E" d="M75.449 52.566c.007 0 .007-.007 0 0 .007-.007.007 0 0 0Z" opacity=".35" />
    <path fill="url(#j)" d="M75.449 52.566c.007 0 .007-.007 0 0 .007-.007.007 0 0 0Z" />
    <defs>
