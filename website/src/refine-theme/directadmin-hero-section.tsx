...
export const EnterpriseHeroSection = ({
    ...
    return (
        ...
        >
            ...
            >
                Built around containers for true per-user isolation, with no account limits tied to a license tier and a fixed price that never changes.{" "}
            </p>
            <div
                className={clsx(
                    "flex flex-col",
            ...
            >
                ...
                >
                    <EnterpriseGetInTouchButton
                        ...
                        eventName="trial_click_hero_directadmin"
                    />
                    <Link
                        ...
                        onClick={(e) => {
                            ...
                            if (
                                ...
                                window.gtag(
                                    "event",
                                    "purchase_click_hero_directadmin",
                                );
                            }
