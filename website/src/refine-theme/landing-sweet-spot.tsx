    ...
    return (
        <div ref={ref} className={clsx(className, "w-full")}>
            ...
            >
                ...
                >
                    <Translate id="homepage.sweetSpot.title"
                        values={{
                            sweetSpot: (
                                <span
                                    className={clsx(
                                ...
                                >
                                    <Translate id="homepage.sweetSpot.title.highlight">sweet spot</Translate>
                                </span>
                            )
                        }}
                    >
                        {"The {sweetSpot} between shared hosting and VPS."}
                    </Translate>
                </h2>
                <p
                    className={clsx(
                ...
                >
                    <Translate id="homepage.sweetSpot.desc">Every OpenPanel user enjoys a dedicated and isolated environment where they can run services, define PHP/MySQL limits, and configure various components such as Varnish, Redis and Elasticsearch.</Translate>
                </p>
            </div>
...
const list = [
    {
        title: <Translate id="homepage.sweetSpot.list.1.title">Nginx, Apache, Varnish</Translate>,
        description: <Translate id="homepage.sweetSpot.list.1.desc">For each user you can choose to use Nginx, OpenLitespeed, Apache, OpenResty or Varnish.</Translate>,
        ...
        iconText: <Translate id="homepage.sweetSpot.list.1.icon">Nginx & OpenLitespeed</Translate>,
        image1Dark:
    ...
    {
        title: <Translate id="homepage.sweetSpot.list.2.title">Isolated services with Docker</Translate>,
        description: <Translate id="homepage.sweetSpot.list.2.desc">Each service is an isolated Docker container that is fully configurable by the user.</Translate>,
        icon: (props: { active: boolean }) => (
        ...
        iconText: <Translate id="homepage.sweetSpot.list.2.icon">Containerized services</Translate>,
        image1Dark:
    ...
    {
        title: <Translate id="homepage.sweetSpot.list.3.title">Database server per user</Translate>,
        description: <Translate id="homepage.sweetSpot.list.3.desc">Each user has their own MySQL or MariaDB instance and can edit configuration settings for their databases.</Translate>,
        icon: (props: { active: boolean }) => (
        ...
        iconText: <Translate id="homepage.sweetSpot.list.3.icon">MySQL, MariaDB, Percona</Translate>,
        image1Dark:
    ...
    {
        title: <Translate id="homepage.sweetSpot.list.4.title">Object caching & Search</Translate>,
        description: <Translate id="homepage.sweetSpot.list.4.desc">REDIS, Memcached and Elasticsearch can be installed with a single click for each user individually.</Translate>,
        icon: (props: { active: boolean }) => (
        ...
        iconText: <Translate id="homepage.sweetSpot.list.4.icon">REDIS & Varnish</Translate>,
        image1Dark:
    ...
    {
        title: <Translate id="homepage.sweetSpot.list.5.title">PHP, Python, NodeJS</Translate>,
        description: <Translate id="homepage.sweetSpot.list.5.desc">Each user can run multiple PHP versions, edit .ini files and set version per domain name.</Translate>,
        icon: (props: { active: boolean }) => (
        ...
        iconText: <Translate id="homepage.sweetSpot.list.5.icon">Multiple PHP versions</Translate>,
        image1Dark:
    ...
    {
        title: <Translate id="homepage.sweetSpot.list.6.title">CSF, CorazaWAF and ImunifyAV</Translate>,
        description: <Translate id="homepage.sweetSpot.list.6.desc">OpenPanel fully supports ConfigServer Sentinel Firewall (CSF) and comes with built-in WAF.</Translate>,
        icon: (props: { active: boolean }) => (
            <AuthenticationIcon
                className={clsx(
                    props.active
        ...
        iconText: <Translate id="homepage.sweetSpot.list.6.icon">CorazaWAF and ImunifyAV</Translate>,
        image1Dark:
