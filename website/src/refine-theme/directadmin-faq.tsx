...
const faq = [
    {
        question: "Can I import existing accounts from a DirectAdmin server?",
    ...
    {
        question: "Are there any limitations regarding the number of user accounts I can create?",
        answer: "No, the Enterprise edition has no limit to the number of user accounts that you can create.",
    },
    {
        question: "Is the pricing fixed, or could it increase over time like DirectAdmin?",
