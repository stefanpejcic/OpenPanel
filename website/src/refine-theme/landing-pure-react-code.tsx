...
export const LandingPureReactCode: FC<Props> = ({
  className,
  title = <Translate id="homepage.pureReact.title">100% Control</Translate>,
  description = <Translate id="homepage.pureReact.desc">Don’t settle for overpriced and outdated hosting panels. With OpenPanel, you maintain 100% control over your server and data at all times.</Translate>,
  cta = true,
}) => {
  return (
          ...
          >
            ...
            {cta && (
              <LandingSectionCtaButton to="/docs">
                <Translate id="homepage.pureReact.cta">Documentation</Translate>
