...
const OPENCLI_COMMANDS: { cmd: string; desc: string; usage: string }[] = [
    ...
    { cmd: `opencli version`, desc: `Displays the current (installed) version of OpenPanel container image.`, usage: `opencli version` },
    ...
    { cmd: `opencli docker-images`, desc: `Check and auto-update container images per user.`, usage: `opencli docker-images [--all|<USERNAME>] [--dry-run] [--force-update]` },
    { cmd: `opencli docker-limits`, desc: `Set global container limits for all containers combined.`, usage: `opencli docker-limits [--apply | --apply SIZE | --read]` },
