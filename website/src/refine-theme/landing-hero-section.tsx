    ...
    return (
        ...
        >
			...
			<span class="text-transparent bg-clip-text bg-gradient-to-r text-gradient-to-r from-[#0FBDBD] to-[#26D97F]">Next Generation</span>  Hosting Panel
                        ...
                        >
							OpenPanel is a multi-user web hosting panel designed around containers. Each user gets their own isolated environment, including separate MySQL server, PHP versions, Redis, and more.
						</p>
                        <p
                            className={clsx(
                                "font-normal",
