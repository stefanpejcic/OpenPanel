...
const tableData = [
        ...
        items: [
            {
                ...
                cyberpanel: (
                    <TableText>51€ / year</TableText>
                ),
                openpanel: (
                    <TableText>149.50€ / year</TableText>
                ),
                valueType: {
                    cyberpanel: "text",
                    openpanel: "text",
        ...
        items: [
            {
                ...
                cyberpanel: <TableText><a href="https://docs.cyberpanel.net/installation-guide/system-requirements/" target="_blank">AlmaLinux 8,9,10 Ubuntu 22 Cloudlinux 7,8,9 RockyLinux 8,9</a></TableText>,
            ...
            },
            {
                ...
                cyberpanel: <TableText>Only with Cloudlinux</TableText>,
                openpanel: <CheckIcon />,
                valueType: {
                    cyberpanel: "text",
                    openpanel: "icon",
    ...
    },
    {
        ...
        items: [
            ...
            {
                description: "Nginx",
                cyberpanel: <TableText>only as a Reverse Proxy</TableText>,
                openpanel: <CheckIcon />,
                valueType: {
                    cyberpanel: "text",
                    openpanel: "icon",
        ...
        items: [
            {
                ...
                cyberpanel: <TableText>8.1 - 8.4</TableText>,
            ...
            },
            {
                ...
                cyberpanel: <TableText>Limited</TableText>,
                openpanel: <CheckIcon />,
                valueType: {
                    cyberpanel: "text",
                    openpanel: "icon",
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                cyberpanel: <TableText>Per user</TableText>,
    ...
    },
    {
        ...
        items: [
            ...
            },            
            {
                ...
                cyberpanel: <TableText>Only with Shell enabled</TableText>,
                openpanel: <CheckIcon />,
                valueType: {
                    cyberpanel: "text",
                    openpanel: "icon",
    ...
    },
    {
        ...
        items: [     
            ...
            },
            {
                ...
                cyberpanel: <TableText>Basic</TableText>,
