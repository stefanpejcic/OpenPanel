...
export const DigitalOceanIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg
        ...
        {...props}
    >
        <g transform="matrix(.494102 0 0 .494102 9.258848 4.55222)" fill="currentColor">
        ...
        <defs><path id="A" d="M204.3 23.4c-1.8 0-3.3.6-4.5 1.8s-1.9 2.7-1.9 4.4c0 1.8.6 3.3 1.9 4.5 1.2 1.2 2.7 1.9 4.5 1.9s3.3-.6 4.5-1.9c1.2-1.2 1.9-2.8 1.9-4.5 0-1.8-.6-3.3-1.9-4.4-1.2-1.2-2.8-1.8-4.5-1.8z" /></defs>
    </svg>
);
