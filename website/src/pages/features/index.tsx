...
const Integrations: React.FC = () => {
    ...
    return (
		...
		Not quite what you would expect from a Control Panel
                ...
                >
					Assign different mysql versions, web servers, and limits per user, let them run containers, manage backups, schedule cron jobs in seconds, tweak configurations, and so much more.
                </div>
            </div>
