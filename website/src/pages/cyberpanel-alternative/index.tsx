...
import { CyberpanelIntroContent } from "@site/src/refine-theme/cyberpanel-intro-content";
    ...
    return (
        <>
            ...
            <SoftwareApplicationSchema
                name="OpenPanel"
                description="OpenPanel is a CyberPanel alternative hosting control panel with Podman-based per-user isolation, native ARM support, and a fixed price per server."
                url="https://openpanel.com/cyberpanel-alternative/"
                offers={{
                    price: "14.95",
                    priceCurrency: "EUR",
