            ...
            <div className="refine-prose">
                ...
                <div className="flex-1 flex flex-col pt-8 lg:pt-16 pb-32 max-w-[800px] w-full mx-auto px-2">
                    ...
                    <ul>
                        ...
                        <li><a href="https://github.com/stefanpejcic/OpenPanel/discussions">Search Discussions</a></li>
                    </ul>
                    ...
                    <h3>Step 2b: Post on GitHub Discussions (Community Edition)</h3>
                    <p>If you can wait for answers from our community and don't want to spend any money, ask your question in GitHub Discussions. Every member of the OpenPanel staff also monitors Discussions and tries to help out whenever we can. We generally prioritize paid support queries (we've got bills to pay, after all), but our Discussions are very active, and our community is knowledgeable.</p>
                    <ul>
                        <li><a href="https://github.com/stefanpejcic/OpenPanel/discussions">Ask the Community</a></li>
                    </ul>
                    ...
                    <p>If you've found a bug in OpenPanel or OpenAdmin, Community or Enterprise edition, <a
                            ...
                            href="https://github.com/stefanpejcic/OpenPanel/discussions">post to Discussions</a> or report to the appropriate <code>security@</code>
