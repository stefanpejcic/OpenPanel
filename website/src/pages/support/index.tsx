            ...
            <div className="refine-prose">
                ...
                <div className="flex-1 flex flex-col pt-8 lg:pt-16 pb-32 max-w-[800px] w-full mx-auto px-2">
                    ...
                    <ul>
                        ...
                        <li><a href="https://community.openpanel.org">Search Forums</a></li>
                    </ul>
                    ...
                    <ul>
                        <li><a href="https://community.openpanel.org">Ask the Community</a></li>
                    </ul>
                    ...
                    <p>If you've found a bug in OpenPanel or OpenAdmin, Community or Enterprise edition, <a
                            ...
                            href="https://community.openpanel.org">post to the forum</a> or report to the appropriate <code>security@</code>
