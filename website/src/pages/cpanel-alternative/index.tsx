...
import { CpanelIntroContent } from "@site/src/refine-theme/cpanel-intro-content";
    ...
    return (
        <>
            ...
            <SoftwareApplicationSchema
                name="OpenPanel"
                description="OpenPanel is a cPanel/WHM alternative hosting control panel with Podman-based per-user isolation, native ARM support, and a fixed price per server."
                url="https://openpanel.com/cpanel-alternative/"
                offers={{
                    price: "14.95",
                    priceCurrency: "EUR",
            ...
            />
            <CommonLayout
                description="Compare OpenPanel vs cPanel/WHM: Podman-based per-user isolation, native ARM support, and a fixed €14.95/month price per server - no per-account fees or hikes."
                image="/img/og/cpanel-alternative.png"
            >
                <div className={clsx()}>
                    <CommonHeader />
                    <div
