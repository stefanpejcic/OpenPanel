...
- excluded MariaDB's *healthcheck* user from MySQL Users list.
...
- fixed bug with `csrf_token` being added in enabled_modules when Features are edited via OpenAdmin.
