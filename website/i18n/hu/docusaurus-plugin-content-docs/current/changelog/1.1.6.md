...
- Renaming Administrator or Reseller user will now also replace the username in all related log files.
...
### 🐛 Bug Fixes
- [Inconsistent memory unit for docker stats #362](https://github.com/stefanpejcic/OpenPanel/issues/362)
